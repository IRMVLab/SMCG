...
from yolov3.models.experimental import CrossConv, MixConv2d, attempt_load
from yolov3.models.yolo import Detect
from yolov3.utils.activations import SiLU
from yolov3.utils.general import LOGGER, make_divisible, print_args
...
class TFModel:
    def __init__(
        self, cfg="yolov3.yaml", ch=3, nc=None, model=None, imgsz=(640, 640)
...
def parse_opt():
    ...
    parser.add_argument(
        "--weights", type=str, default=ROOT / "yolov3.pt", help="weights path"
    )
    parser.add_argument(
        "--imgsz",
        "--img",
