...
_C.OBS_TO_SAVE = ["panoramic_rgb", "panoramic_depth", "target_goal", "semantic"]
...
def get_config(
    ...
    Args:
        ...
        opts: Config options (keys, values) in a list (e.g.txt., passed from
    ...
    if not os.path.exists(config.EVAL_CKPT_PATH_DIR):
        os.mkdir(config.EVAL_CKPT_PATH_DIR)
